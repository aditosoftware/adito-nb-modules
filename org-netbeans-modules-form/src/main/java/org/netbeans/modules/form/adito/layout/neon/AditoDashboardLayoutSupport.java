...
public class AditoDashboardLayoutSupport extends AbstractLayoutSupport
{
  ...
  public Class getSupportedClass()
  {
    ...
    return layoutProvider.getDashboardLayout().getLayoutClass();
  }
...
//    }
  ...
  {
    Rectangle r = ((AditoDashboardConstraints) newConstraints).getBounds();
  ...
  @Override
  protected AditoDashboardConstraints createDefaultConstraints()
  {
    return new AditoDashboardConstraints();
  }
                                              ...
                                              Insets sizeChanges, Point posInCont, int index, Point pPosInComp)
  {
    ...
    AditoDashboardConstraints constr = (AditoDashboardConstraints) getConstraints(index);
    constr = constr == null ? createDefaultConstraints() : (AditoDashboardConstraints) constr.cloneConstraints();
    IAditoLayoutConstraints<IDashletPropertyTypes> co = constr.getConstraintsObject();
    IDashletPropertyTypes typeInfo = co.getTypeInfo();

    try
    {
      co.get(typeInfo.xPos()).setValue(area.startX());
      co.get(typeInfo.yPos()).setValue(area.startY());
      co.get(typeInfo.colspan()).setValue(area.endX());
      co.get(typeInfo.rowspan()).setValue(area.endY());
