...
* <dl><dt style="font-weight:bold"> <code>string</code> </dt><dd> Any string.
* </dd></dl>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>nameAttribute</code> </dt><dd> A string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>index</code> </dt><dd> An integer between 0 and 1 less than the length of the string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </pre>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>index</code> </dt><dd> An integer between 0 and 1 less than the length of the string; if unspecified, defaults to 0.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>string2...string<i>N</i></code> </dt><dd> Strings to concatenate to this string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>color</code> </dt><dd> A string expressing the color as a hexadecimal RGB triplet or as a string literal. String literals for color names are listed in the <a href="Core_JavaScript_1.5_Guide" shape="rect" title="Core JavaScript 1.5 Guide">Core JavaScript 1.5 Guide</a>.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>size</code> </dt><dd> An integer between 1 and 7, a string representing a signed integer between 1 and 7.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>num1, ..., num<i>N</i></code> </dt><dd> A sequence of numbers that are Unicode values.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>searchValue</code> </dt><dd> A string representing the value to search for.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>fromIndex</code> </dt><dd> The location within the calling string to start the search from. It can be any integer between 0 and the length of the string. The default value is 0.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* <dl><dt style="font-weight:bold"> <code>searchValue</code> </dt><dd> A string representing the value to search for.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>fromIndex</code> </dt><dd> The location within the calling string to start the search from. It can be any integer between 0 and the length of the string. The default value is the length of the string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>hrefAttribute</code> </dt><dd> Any string that specifies the <code>HREF</code> of the <code>A</code> tag; it should be a valid URL (relative or absolute).
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>regexp</code> </dt><dd> A <a href="RegExp" shape="rect" title="Core JavaScript 1.5 Reference:Global Objects:RegExp"> regular expression</a> object. If a non-RegExp object <code>obj</code> is passed, it is implicitly converted to a RegExp by using <code>new RegExp(obj)</code>.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* <ul><li> See ¬ß15.5.4.10 of the ECMA-262 specification.
* </li></ul>
* <h2> <span> Examples </span></h2>
...
* </pre>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>regexp</code> </dt><dd> A <a href="RegExp" shape="rect" title="Core JavaScript 1.5 Reference:Objects:RegExp"> RegExp</a> object. The match is replaced by the return value of parameter #2.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>substr</code> </dt><dd> A <a href="String" shape="rect" title="Core JavaScript 1.5 Reference:Objects:String"> String</a> that is to be replaced by <code>newSubStr</code>.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>newSubStr</code> </dt><dd> The <a href="String" shape="rect" title="Core JavaScript 1.5 Reference:Objects:String"> String</a> that replaces the substring received from parameter #1.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>function</code> </dt><dd> A function to be invoked to create the new substring (to put in place of the substring received from parameter #1).
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>flags</code> </dt><dd> <i>(<a href="http://developer.mozilla.org/en/docs/SpiderMonkey" shape="rect" title="SpiderMonkey">SpiderMonkey</a> extension)</i> A <a href="String" shape="rect" title="Core JavaScript 1.5 Reference:Objects:String"> String</a> containing any combination of the RegExp flags: <code>g</code> - global match, <code>i</code> - ignore case, <code>m</code> - match over multiple lines. This parameter is only used if the first parameter is a string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </pre>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>beginSlice</code> </dt><dd> The zero-based index at which to begin extraction.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>endSlice</code> </dt><dd> The zero-based index at which to end extraction. If omitted, <code>slice</code> extracts to the end of the string.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </pre>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>start</code> </dt><dd> Location at which to begin extracting characters (an integer between 0 and one less than the length of the string).
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>length</code> </dt><dd> The number of characters to extract.
* </dd></dl>
* <h2> <span> Description </span></h2>
...
* </p>
* <h2> <span> Parameters </span></h2>
* <dl><dt style="font-weight:bold"> <code>indexA</code> </dt><dd> An integer between 0 and one less than the length of the string.
* </dd></dl>
* <dl><dt style="font-weight:bold"> <code>indexB</code> </dt><dd> (optional) An integer between 0 and the length of the string.
* </dd></dl>
* <h2> <span> Description </span></h2>
