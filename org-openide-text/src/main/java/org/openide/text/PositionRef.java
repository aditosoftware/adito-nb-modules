...
public final class PositionRef extends Object implements Serializable, Position {
    ...
    */
    PositionRef(Manager manager, int offset, Bias bias) {
    ...
    * @param bias the bias for the position
    */
    PositionRef(Manager manager, int line, int column, Bias bias) {
    ...
    */
    private PositionRef(Manager manager, Manager.Kind kind, Bias bias) {
        this.manager = manager;
        insertAfter = (bias == Bias.Backward);
        init(kind, "new");
    }
    ...
    */
    public Bias getPositionBias() {
        return insertAfter ? Bias.Backward : Bias.Forward;
    }
    ...
    static final class Manager extends Object implements Runnable, Serializable {
            ...
            protected PositionKind toMemoryLockAcquired(boolean insertAfter) {
                ...
                try {
                    p = NbDocument.createPosition(
                            mgr.getDoc(), offset,
                            insertAfter ? Bias.Backward : Bias.Forward
                    );
        ...
        */
        private static final class OutKind extends Kind {
            ...
            */
            OutKind(PositionKind kind, Manager mgr) {
                super(mgr);
