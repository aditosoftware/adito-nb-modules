...
public class CloneableEditor extends CloneableTopComponent implements CloneableEditorSupport.Pane {
    ...
    * {@link CloneableEditorSupport#CloneableEditorSupport(CloneableEditorSupport.Env, Lookup) lookup}.
    * 
    * @param support support that holds the document and operations above it
    ...
    */
     ...
     * this editor via its {@link CloneableEditorSupport#initializeCloneableEditor(CloneableEditor)}
     ...
     * {@link EditorCookie.Observable#PROP_OPENED_PANES}
...
//                        pane.setDocument(doc);
     ...
     * {@link TopComponent TopCompoenent}
                ...
                if (p instanceof QuietEditorPane) {
                    ...
                    if (lastPos == -1) {
                        Logger.getLogger(CloneableEditor.class.getName()).log(Level.WARNING, null,
                                          new IllegalStateException("Pane=" +
                                                                              p +
                    ...
                    if (doc != null) {
                        Logger.getLogger(CloneableEditor.class.getName()).log(Level.WARNING, null,
                                          new IllegalStateException("Caret is null in editor pane=" +
                                                                              p +
                                                                              "\nsupport=" +
                                                                              support +
                                                                              "\ndoc=" +
     ...
     * throws {@link NotSerializableException NotSerializableException}.
