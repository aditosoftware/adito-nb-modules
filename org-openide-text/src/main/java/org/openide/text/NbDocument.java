...
public final class NbDocument extends Object {
    ...
    */
     ...
     * to implement {@link Printable} to describe how to print in terms of
     ...
     *
     * <p>Method will throw {@link UserQuestionException}
     * exception if file size is too big. This exception is caught and its
     * method {@link UserQuestionException#confirmed} is used
     * for confirmation.
     *
     *
     ...
     * @param openType control open behavior, {@link Line.ShowOpenType#OPEN}
     * would typically be used
     * @param visibilityType control visibility behavior, {@link Line.ShowVisibilityType#FOCUS}
     * would typically be used
