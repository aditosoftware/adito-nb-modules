...
* {@link EditorCookie}, {@link org.openide.cookies.OpenCookie},
...
//            }
    ...
    */
     ...
     * See {@link EditorCookie.Observable}.
    ...
    * it is.
    * 
    * <p>Method will throw {@link UserQuestionException} exception
    * if file size is too big. This exception could be caught and 
    * its method {@link UserQuestionException#confirmed}
    ...
    * See also {@link EditorCookie.Observable}.
    */
    @Deprecated
    ...
    */
     ...
     * was written out to the {@link Env} (usually disk). So it will contain
     * guarded block markers etc. If the document is not loaded,
     * then the <code>InputStream</code> will be taken from the {@link Env}.
     *
