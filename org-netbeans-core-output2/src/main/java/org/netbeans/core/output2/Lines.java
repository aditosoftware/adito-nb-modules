...
public interface Lines {
     ...
     * @return The text
     * @throws java.io.IOException If an error occurs and the text cannot be read
     */
     ...
     * @throws java.io.IOException If there is a problem writing or encoding the data, or if overwrite is false and the
