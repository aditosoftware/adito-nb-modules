...
//end of MSSQL hack
    ...
    {
      switch (ii)
      { //cannot find 'ii' type, try to find it in java.sql.Types
        case -7:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_BIT");
          break; //NOI18N
        case -6:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_TINYINT");
          break; //NOI18N
        case 5:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_SMALLINT");
          break; //NOI18N
        case 4:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_INTEGER");
          break; //NOI18N
        case -5:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_BIGINT");
          break; //NOI18N
        case 6:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_FLOAT");
          break; //NOI18N
        case 7:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_REAL");
          break; //NOI18N
        case 8:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_DOUBLE");
          break; //NOI18N
        case 2:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_NUMERIC");
          break; //NOI18N
        case 3:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_DECIMAL");
          break; //NOI18N
        case 1:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_CHAR");
          break; //NOI18N
        case 12:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_VARCHAR");
          break; //NOI18N
        case -1:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_LONGVARCHAR");
          break; //NOI18N
        case 91:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_DATE");
          break; //NOI18N
        case 92:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_TIME");
          break; //NOI18N
        case 93:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_TIMESTAMP");
          break; //NOI18N
        case -2:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_BINARY");
          break; //NOI18N
        case -3:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_VARBINARY");
          break; //NOI18N
        case -4:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_LONGVARBINARY");
          break; //NOI18N
        case 0:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_NULL");
          break; //NOI18N
        case 1111:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_OTHER");
          break; //NOI18N
        case 2000:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_JAVA_OBJECT");
          break; //NOI18N
        case 2001:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_DISTINCT");
          break; //NOI18N
        case 2002:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_STRUCT");
          break; //NOI18N
        case 2003:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_ARRAY");
          break; //NOI18N
        case 2004:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_BLOB");
          break; //NOI18N
        case 2005:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_CLOB");
          break; //NOI18N
        case 2006:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_REF");
          break; //NOI18N
        default:
          name = NbBundle.getMessage(DatabaseTypePropertyEditor.class, "SQL_UNKNOWN"); //NOI18N
      }
      index = 0;
    }
    else
