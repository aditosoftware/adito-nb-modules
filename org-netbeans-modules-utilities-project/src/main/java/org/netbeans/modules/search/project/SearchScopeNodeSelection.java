...
final class SearchScopeNodeSelection extends SearchScopeDefinition
    ...
    public SearchInfo getSearchInfo() {
        Node[] fileObjectChildNodes = getFileObjectChildNodes(TopComponent.getRegistry().getActivatedNodes());
        return getSearchInfo(fileObjectChildNodes);
    }
    ...
    private Node[] getFileObjectChildNodes(Node[] pNodes)
    {
        ...
        nodeSet.addAll(Arrays.asList(childNodes));
